...
#define _MOTORCONTROLLER_H
	...
	#include <RoverCalibration.h>
		...
		void motorControllerPowerOnCalibration(BufferSelect *);//calibrates the motor controller upon start up by exercising the full range of the channels. Will only work when Rover Buffer is in Auto Mode and the Motor Power Control is enabled in software in the MAIN code, or the HW switch for Motor Power Control is on
