...
public:
	...
	double voltageRead(byte);//(analog pin)does an accurate reading of the analog to digital converter by first measuring Vcc then using it in the calucations with the standard analog read (instead of assuming Vcc is 5V), returns the voltage in Volts
