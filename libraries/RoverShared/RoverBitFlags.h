...
//TEMPLATE//				#define _BTFG_FIRST_TRANSMISSION_								0x01
		...
		#define _BTFG_LED_STATE_FRONT_RIGHT_IR_BEACON					0x01
		#define _BTFG_LED_STATE_RIGHT_BLUE_BEACON					0x02
		#define _BTFG_LED_STATE_BACK_RIGHT_IR_BEACON					0x04
		#define _BTFG_LED_STATE_BACK_BLUE_BEACON					0x08
		#define _BTFG_LED_STATE_BACK_LEFT_IR_BEACON					0x10
		#define _BTFG_LED_STATE_LEFT_BLUE_BEACON					0x20
		#define _BTFG_LED_STATE_FRONT_LEFT_IR_BEACON					0x40
		#define _BTFG_LED_STATE_LEFT_SIDE_SIGNAL_LIGHT					0x80
		//LED State Flag: Set 2: Used in _ledStateFlagSet2
		#define _BTFG_LED_STATE_LEFT_HIGHBEAM_HEADLIGHT					0x01
		#define _BTFG_LED_STATE_LEFT_SIGNAL_HEADLIGHT					0x02
		#define _BTFG_LED_STATE_LEFT_FOG_HEADLIGHT					0x04
		#define _BTFG_LED_STATE_RIGHT_FOG_HEADLIGHT					0x08
		#define _BTFG_LED_STATE_RIGHT_SIGNAL_HEADLIGHT					0x10
		#define _BTFG_LED_STATE_RIGHT_HIGHBEAM_HEADLIGHT					0x20
		#define _BTFG_LED_STATE_RIGHT_SIDE_SIGNAL_LIGHT					0x40
		#define _BTFG_LED_STATE_RIGHT_WHITE_TAILLIGHT					0x80		
		//LED State Flag: Set 3: Used in _ledStateFlagSet3
		#define _BTFG_LED_STATE_RIGHT_RED1_TAILLIGHT				0x01
		#define _BTFG_LED_STATE_RIGHT_RED5_TAILLIGHT					0x02
		#define _BTFG_LED_STATE_RIGHT_RED2_TAILLIGHT					0x04
		#define _BTFG_LED_STATE_RIGHT_RED4_TAILLIGHT				0x08
		#define _BTFG_LED_STATE_RIGHT_RED3_TAILLIGHT					0x10
		#define _BTFG_LED_STATE_LEFT_RED3_TAILLIGHT					0x20
		#define _BTFG_LED_STATE_LEFT_RED4_TAILLIGHT					0x40
		#define _BTFG_LED_STATE_LEFT_RED2_TAILLIGHT					0x80		
		//LED State Flag: Set 4: Used in _ledStateFlagSet4
		#define _BTFG_LED_STATE_LEFT_RED5_TAILLIGHT					0x01
		#define _BTFG_LED_STATE_LEFT_RED1_TAILLIGHT					0x02
		#define _BTFG_LED_STATE_LEFT_WHITE_TAILLIGHT					0x04
		#define _BTFG_LED_STATE_UNDERGLOW_LIGHT					0x08
