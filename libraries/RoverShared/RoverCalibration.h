...
//The order of defining the flag then calling #include <RoverCalibration.h> matters. You have to define the flags first, then call #include <RoverCalibration.h>
	...
	//definitions for ImuSensor
		...
		*/
		...
		#define RESISTOR_CURRENTCCA_7D2V_FROM_R_IN																			10000 //On the CURRENT_SENSOR_UNIT_CCAv2 as Reference Designator: R7
		#define RESISTOR_CURRENTCCA_7D2V_TO_R_OUT																			10000 //On the CURRENT_SENSOR_UNIT_CCAv2 as Reference Designator: R8
