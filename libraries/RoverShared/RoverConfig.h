...
//The order of defining the flag then calling #include <RoverConfig.h> matters. You have to define the flags first, then call #include <RoverConfig.h>
	...
	//definition for LedControllers
		...
		#define LED_STARTUP_MODE 				2//Typically set to this mode on power up/reset. It should turn on all the LEDs for about 2 seconds (so the user can see that all the LEDs are working, then it should turn it off and go into LED_ALL_OFF_MODE automatically afterwards.
		...
		#define LED_DEBUG_MODE										8//(Note: This is not currently implemented.) Allow any temporary debugging code to control the LEDs discretely. All LEDs in this mode should only be controlled manually by userDiscreteLEDControl().
	...
	*/
	...
	//Used for NAVI State Machine
		...
		#define LED_SET_GENERIC_HEALTH_ERROR	1//To Be Defined Later
		#define LED_SET_GENERIC_SYSTEM_ERROR	2//To Be Defined Later
		#define LED_SET_SYNC_ERROR	3//To Be Defined Later
...
//TEMPLATE//		#define MAIN_SYSTEM_ERROR_TIMEOUT_VALUE 50//time for MAIN to wait in SYSTEM_ERROR before it should reset a hw reset from COMM			
	...
	//Pinouts for Arduino 1: NAVI (MEGA)
		...
		#define RIGHT_RED_TAILLIGHT_1_PIN			31
		#define LEFT_HIGHBEAM_HEADLIGHT_PIN			32
		#define RIGHT_RED_TAILLIGHT_2_PIN			33
		#define LEFT_SIGNAL_HEADLIGHT_PIN				34
		#define RIGHT_RED_TAILLIGHT_3_PIN			35
		#define LEFT_FOG_HEADLIGHT_PIN					36
		#define RIGHT_WHITE_TAILLIGHT_PIN				37
		#define FRONT_LEFT_BEACON_IR_PIN					38
		#define RIGHT_RED_TAILLIGHT_5_PIN			39
		#define BACK_LEFT_BEACON_IR_PIN					40
		#define RIGHT_RED_TAILLIGHT_4_PIN			41
		#define BACK_RIGHT_BEACON_IR_PIN					42
		#define LEFT_RED_TAILLIGHT_3_PIN			43
		#define FRONT_RIGHT_BEACON_IR_PIN					44
		#define LEFT_RED_TAILLIGHT_2_PIN			45
		#define LEFT_BEACON_BLUE_PIN				46
		#define LEFT_RED_TAILLIGHT_1_PIN			47
		#define BACK_BEACON_BLUE_PIN				48
		#define LEFT_RED_TAILLIGHT_4_PIN			49
		#define RIGHT_BEACON_BLUE_PIN				50
		#define LEFT_RED_TAILLIGHT_5_PIN			51
		#define FRONT_BEACON_BLUE_PIN				52
		#define LEFT_WHITE_TAILLIGHT_PIN				53		
